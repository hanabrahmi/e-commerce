                ...
                <div className="container topbar bg-primary d-none d-lg-block">
                    <div className="d-flex justify-content-between">
                        <div className="top-info ps-2">
                            <small className="me-3"><i className="fas fa-envelope me-2 text-secondary"></i><Link to="#" className="text-white">BrandBridge@gmail.com</Link></small>
                        </div>
                    ...
                    <nav className="navbar navbar-light bg-white navbar-expand-xl">
                        ...
                        <div className="collapse navbar-collapse " id="navbarCollapse">
                            <div className="navbar-nav mx-auto">
                                ...
                                <Link to="/categorie" className="nav-item nav-link">Catégorie</Link>
                            ...
                            <div className="d-flex m-3 me-0 justify-content-center">
                                ...
                                <Link to="/cart" className="position-relative mx-2 my-auto">
